...
version 1. The helper script in `tools/` regenerates the declarative XML, but it
...
```sh
java -jar ../fuzzy-time-android-gb-poc/wff-validator.jar 1 watchface/src/main/res/raw/watchface.xml
```
